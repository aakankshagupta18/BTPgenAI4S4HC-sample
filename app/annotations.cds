...
annotate aakankshagupta_ds1_a29Srv.CustomerMessage with @UI.DataPoint #customerName: {
  Value: customerName,
  Title: 'Customer Name',
};
annotate aakankshagupta_ds1_a29Srv.CustomerMessage with @UI.DataPoint #productName: {
  Value: productName,
  Title: 'Product Name',
};
annotate aakankshagupta_ds1_a29Srv.CustomerMessage with {
...
annotate aakankshagupta_ds1_a29Srv.CustomerMessage with @UI.HeaderFacets: [
...
annotate aakankshagupta_ds1_a29Srv.CustomerMessage with @UI.Facets: [
