 ...
 * @Before(event = { "READ" }, entity = "aakankshagupta_ds1_a29Srv.CustomerMessage")
...
try {
    ...
    const customerMessages = await SELECT.from('aakankshagupta_ds1_a29.CustomerMessage').forUpdate();
